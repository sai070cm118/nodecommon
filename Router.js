...
const sqlRepository = require('./PKG.SocketControllers/SqlRepository');
var us = require('microtime');
const errorLogger = require('./PKG.SDK.Packages/PKG.ErrorLogger/index');

module.exports = function(message,userId,callback,isApi) {
    try{
            ...
            if(findedProcedureParams != null){
                ...
                sqlRepository(findedRoute.ProcedureName,findedProcedureParams,function(err,result){
                    ...
                    if(err){
                        ...
                        if(isApi){
                            var resObj = result.output;
                            resObj.Data = result.recordsets;
                            callback( resObj );
                        }
                        else
